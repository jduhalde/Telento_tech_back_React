...
2. Crear entorno virtualEs recomendable usar un entorno virtual para aislar las dependencias.Windowspython -m venv venv.\venv\Scripts\activateMac/Linuxpython3 -m venv venvsource venv/bin/activate

3. Instalar dependenciasInstala todas las librerías necesarias listadas en el archivo requirements.txt.pip install -r requirements.txt.
...
Para acceder al panel de administración y gestionar productos desde el frontend, debes crear un superusuario.python manage.py createsuperuser
...
Este proyecto está configurado para desplegarse en plataformas como Railway.
